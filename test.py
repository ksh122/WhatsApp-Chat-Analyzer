...
class AuthenticationSystem:
    ...
    def login(self, username, password):
        ...
        user = User(user_row['user_id'].values[0], user_row['username'].values[0], user_row['password'].values[0], 
                    3 - user_row['failed_attempts_left'].values[0], user_row['is_locked'].values[0]) 
    ...
    def update_user(self, user):
        ...
        self.users.loc[self.users['username'] == user.username, 'failed_attempts_left'] = 3 - user.failed_attempts
